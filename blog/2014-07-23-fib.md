...
```{pipe="sh > /dev/null"}
git clone git://gitorious.org/php-prelude/php-prelude.git
git clone git://gitorious.org/php-core/php-core.git
git clone git://gitorious.org/php-easycheck/php-easycheck.git
